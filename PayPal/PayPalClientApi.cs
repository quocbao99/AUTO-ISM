...
using MyPayPal.Models.Responses;
...
namespace PayPal
{
    public class PayPalClientApi
    {
        ...
        public async Task<CreateProductReponse> CreateProduct(CreateProductRequest request)
        {
            EnsureHttpClientCreated();
            ...
            var response = await _client.PostAsync($"{ConfigHelper.BaseUrl}/v1/catalogs/products", httpRequestMessage.Content);
